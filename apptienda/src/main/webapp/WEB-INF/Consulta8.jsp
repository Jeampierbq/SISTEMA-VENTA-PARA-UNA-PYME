...
<html lang="en">
    ...
    <div class="container">
        ...
        <% ArrayList<Producto> arts = (ArrayList<Producto>) request.getAttribute("producto");%>
            ...
            <div>
               <button class="btn btn-primary"><a href="nuevoArt" style=" color: white"  class="frontpage_heading">Agregar</a></button> 
            </div>
</form>
        </div>
            ...
            <tbody>
                <%for (Producto x : arts) {%>
                    <tr>
                        ...
                        <td><a href="editarArt?id=<%= x.getIdproducto() %>"><img style="width:40px; height:40px;" class="small-image" src="https://www.nicepng.com/png/detail/53-538741_block-de-nota-y-lapiz-bloc-de-notas.png" alt="Editar"></a></td>
