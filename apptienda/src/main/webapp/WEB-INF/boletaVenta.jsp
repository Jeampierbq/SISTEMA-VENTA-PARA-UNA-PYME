<%-- 
    ...
    Created on : 10 dic. 2023, 23:15:49
    Author     : Apo
--%>
...
<html lang="en">
 ...
 body {
    ...
    <div class="info-section">
        ...
        <p><strong>Nombre del Producto:</strong> ${param.nombreProducto}</p>
        <p><strong>Descripción:</strong> ${param.descripcion}</p>
        <p><strong>Precio:</strong> ${param.precio}</p>
        <p><strong>Foto:</strong> ${param.foto}</p>
        <p><strong>Fecha de vencimiento:</strong> ${param.fechaVencimiento}</p>
        <p><strong>Id de Categoría:</strong> ${param.idCategoria}</p>
        <p><strong>Cantidad:</strong> ${param.cantidad}</p>
        <p><strong>Id del Producto:</strong> ${param.idProducto}</p>

        <!-- Información del Cliente -->
        <p><strong>Nombre del Cliente:</strong> ${param.nombreCliente}</p>
        <p><strong>Id del Cliente:</strong> ${param.idCliente}</p>
        <p><strong>Apellido Paterno:</strong> ${param.apellidoPaterno}</p>
        <p><strong>Apellido Materno:</strong> ${param.apellidoMaterno}</p>
        <p><strong>DNI:</strong> ${param.dniCliente}</p>
        <p><strong>Celular:</strong> ${param.celularCliente}</p>

        <!-- Agregar el resto de la información que deseas mostrar -->
    </div>
    <div class="text-center">
        <button type="button" class="btn btn-primary" onclick="window.print()">Imprimir Boleta</button>
    </div>
</div>
 ...
 <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Obtener todos los elementos de input y deshabilitar su edición
